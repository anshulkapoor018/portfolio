...
export const projectsData: Project[] = [
  ...
  },
  {
    dateStart: "Jan 2016",
    dateEnd: "May 2016",
    name: "Movies Prediction Using Data Mining",
    stack: ["Python", "HTML", "CSS", "JavaScript", "Flask"],
    projectDetails: "- Developed a movie analytics platform using clustering algorithms and genetic optimization techniques for predictive analysis and trend visualization."
  },
];
